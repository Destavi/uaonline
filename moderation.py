...
from services.stats_manager import update_stat_v2, get_stats, load_logs, log_mod_action
...
class Moderation(commands.Cog):
    ...
    async def ban(self, interaction: discord.Interaction, member: discord.Member, duration: str = None, reason: str = "Не вказана"):
        ...
        try:
            ...
            update_stat_v2(interaction.guild.id, "ban_issued", interaction.user.id)
    ...
    async def mute(self, interaction: discord.Interaction, member: discord.Member, duration: str, reason: str = "Не вказана"):
        ...
        try:
            ...
            try:
                update_stat_v2(interaction.guild.id, "mute_issued", interaction.user.id)
    ...
    async def warn(self, interaction: discord.Interaction, member: discord.Member, reason: str):
        ...
        update_stat_v2(interaction.guild.id, "warn_issued", interaction.user.id)
    ...
    async def unban(self, interaction: discord.Interaction, user_id: str, reason: str = "Не вказана"):
        ...
        try:
            ...
            update_stat_v2(interaction.guild.id, "ban_removed", interaction.user.id)
    ...
    async def unmute(self, interaction: discord.Interaction, member: discord.Member):
        ...
        try:
            ...
            update_stat_v2(interaction.guild.id, "mute_removed", interaction.user.id)
    ...
    async def unwarn(self, interaction: discord.Interaction, member: discord.Member, warn_id: int):
        ...
        update_stat_v2(interaction.guild.id, "warn_removed", interaction.user.id)
